...
// Re-export EffortLevel from tjuae-types (single source of truth)
pub use tjuae_types::skill_types::EffortLevel;
...
pub enum SkillSource {
    /// `<config_dir>/tjuae/skills/`
    User,
    /// .tjuae/skills/ (project-level)
    Project,
