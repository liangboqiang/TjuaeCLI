...
use std::fmt;
use tjuae_config::compat::{self, ProviderCompat, ToolWireShape};
use tjuae_config::schema::legalize_json_schema;
use tjuae_types::llm::{LlmRequest, ThinkingConfig};
use tjuae_types::tool::{ToolDef, truncate_deferred_description};
