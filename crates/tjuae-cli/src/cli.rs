...
#[command(
    name = "tjuae-cli",
    about = "TjuaeCLI — a multi-provider AI agent CLI with tool orchestration support",
    version
)]
pub(crate) struct Cli {
    ...
    /// Project directory to load .tjuae.toml from (defaults to CWD)
    #[arg(long)]
    ...
    /// Log level filter (e.g. "info", "debug", "info,tjuae_providers=debug")
    #[arg(long)]
