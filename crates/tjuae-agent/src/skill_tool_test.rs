...
mod tests {
    ...
    use tjuae_skills::types::{ExecutionContext, LoadedFrom, SkillSource};
...
mod supplemental_tests {
    ...
    async fn tc_13_8_full_variable_substitution_integration() {
        let mut skill = make_skill("my-skill", "Run ${TJUAE_SKILL_DIR}/tool.sh $ARGUMENTS[0]");
...
mod supplemental_tests_p6 {
    ...
    use tjuae_skills::permissions::SkillPermissionChecker;
    use tjuae_skills::types::{EffortLevel, ExecutionContext, LoadedFrom, SkillMetadata, SkillSource};
    use tjuae_tools::Tool;
