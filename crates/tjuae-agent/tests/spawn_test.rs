...
use tjuae_agent::spawner::{AgentSpawner, SubAgentConfig};
use tjuae_agent::tool_policy::ToolPolicy;
...
async fn test_spawn_shares_provider() {
    ...
    let provider_dyn: Arc<dyn tjuae_providers::LlmProvider> = provider;
    let spawner = AgentSpawner::new(
