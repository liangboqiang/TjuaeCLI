...
use tjuae_providers::{LlmProvider, ProviderError};
use tjuae_tools::Tool;
use tjuae_types::llm::{LlmEvent, LlmRequest};
use tjuae_types::message::{StopReason, TokenUsage};
...
pub fn test_config() -> Config {
    Config {
        ...
        compat: tjuae_config::compat::ProviderCompat::anthropic_defaults(),
        tools: ToolsConfig {
            auto_approve: true,
            allow_list: vec![],
        ...
        session: SessionConfig {
            enabled: false,
            directory: "/tmp/tjuae-test-sessions".to_string(),
            max_sessions: 5,
        },
