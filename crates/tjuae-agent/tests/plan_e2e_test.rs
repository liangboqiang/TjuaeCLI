...
use serde_json::json;
use tjuae_agent::plan::prompt::plan_mode_instructions;
use tjuae_agent::plan::tools::{EnterPlanModeTool, ExitPlanModeTool};
use tjuae_protocol::events::ToolCategory;
use tjuae_tools::Tool;
use tjuae_tools::registry::ToolRegistry;
use tjuae_types::skill_types::PlanModeTransition;
...
fn tc_3_6_e2e_02_plan_mode_and_compaction_independent() {
    use tjuae_agent::compact::micro::microcompact;
    use tjuae_agent::plan::state::PlanState;
