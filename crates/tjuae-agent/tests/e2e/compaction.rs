...
use serde_json::json;
use tjuae_agent::confirm::ToolConfirmer;
use tjuae_agent::engine::AgentEngine;
use tjuae_agent::orchestration::execute_tool_calls;
use tjuae_agent::output::OutputSink;
use tjuae_agent::output::null_sink::NullSink;
use tjuae_compact::CompactLevel;
use tjuae_config::compat::ProviderCompat;
use tjuae_config::config::{Config, ProviderType, SessionConfig, ToolsConfig};
use tjuae_config::hooks::HooksConfig;
use tjuae_mcp::config::McpConfig;
use tjuae_providers::create_provider;
...
fn openai_config(api_key: &str) -> Config {
    Config {
        ...
        tools: ToolsConfig {
            auto_approve: true,
            allow_list: vec![],
            skills: tjuae_config::config::SkillsPermissionConfig::default(),
        },
        ...
        compact: tjuae_config::compact::CompactConfig::default(),
        plan: tjuae_config::plan::PlanConfig::default(),
        shell: tjuae_config::shell::ShellConfig::default(),
        file_cache: tjuae_config::file_cache::FileCacheConfig::default(),
        hooks: HooksConfig::default(),
        bedrock: None,
        vertex: None,
        mcp: McpConfig::default(),
        logging: tjuae_config::logging::LoggingConfig::default(),
    }
}
...
impl tjuae_tools::Tool for FixedOutputTool {
    fn name(&self) -> &str {
        &self.name
    }
    ...
    fn category(&self) -> tjuae_protocol::events::ToolCategory {
        tjuae_protocol::events::ToolCategory::Info
    }
    ...
    async fn execute(&self, _input: serde_json::Value) -> tjuae_types::tool::ToolResult {
        tjuae_types::tool::ToolResult {
